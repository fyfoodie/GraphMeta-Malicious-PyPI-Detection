...
We utilize Python's `ast` module to parse the source code of `.py` files (extracted from `.tar.gz`, `.zip`, or `.whl` archives) into a tree structure. 
This allows us to understand the code's execution flow without running it[cite: 98, 175].
